...
import type {
  ...
  CreateChatCompletionEvent,

  CreateChatCompletionEvent2,
...
export class ApiClient {
  ...
  async *createChatCompletionStream(body: CreateChatCompletionBody, options?: SSEOptions): AsyncGenerator<CreateChatCompletionStreamEvent> {
  ...
  async createChatCompletion(body: CreateChatCompletionBody, options?: RequestOptions): Promise<CreateChatCompletionResponse> {
  ...
  async *createChatCompletionStream(body: CreateChatCompletionStreamBody, options?: SSEOptions): AsyncGenerator<CreateChatCompletionStreamStreamEvent> {
