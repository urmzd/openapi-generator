...
export class ApiClient {
  ...
  async listPets(limit?: number, status?: string, options?: RequestOptions): Promise<ListPetsResponseItem[]> {
  ...
  async updatePet(petId: string, body: UpdatePetBody, options?: RequestOptions): Promise<UpdatePetResponse> {
