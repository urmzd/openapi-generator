...
export class ApiClient {
  ...
  async listPets(
    limit?: number,
    options?: RequestOptions,
  ): Promise<(ListPetsResponseItemVariant1 | ListPetsResponseItemVariant2)[]> {
    const path = "/pets";
    return this.request<(ListPetsResponseItemVariant1 | ListPetsResponseItemVariant2)[]>(
      "GET",
      path,
      {
        query: { limit: limit },
  ...
  async listPetsRaw(
    limit?: number,
    options?: RequestOptions,
  ): Promise<ApiResponse<(ListPetsResponseItemVariant1 | ListPetsResponseItemVariant2)[]>> {
    const path = "/pets";
    return this.rawRequest<(ListPetsResponseItemVariant1 | ListPetsResponseItemVariant2)[]>(
      "GET",
      path,
      {
        query: { limit: limit },
  ...
  /** Create a pet */
  async createPet(
    body: CreatePetBodyVariant1 | CreatePetBodyVariant2,
    options?: RequestOptions,
  ): Promise<CreatePetResponseVariant1 | CreatePetResponseVariant2> {
    const path = "/pets";
    return this.request<CreatePetResponseVariant1 | CreatePetResponseVariant2>("POST", path, {
      body,
  ...
  async createPetRaw(
    body: CreatePetBodyVariant1 | CreatePetBodyVariant2,
    options?: RequestOptions,
  ): Promise<ApiResponse<CreatePetResponseVariant1 | CreatePetResponseVariant2>> {
    const path = "/pets";
    return this.rawRequest<CreatePetResponseVariant1 | CreatePetResponseVariant2>("POST", path, {
      body,
      contentType: "application/json",
      ...options,
    });
  ...
  async getPet(
    petId: string,
    options?: RequestOptions,
  ): Promise<GetPetResponseVariant1 | GetPetResponseVariant2> {
    let path = "/pets/{petId}";
    path = path.replace("{petId}", encodeURIComponent(String(petId)));
    return this.request<GetPetResponseVariant1 | GetPetResponseVariant2>("GET", path, {
      ...options,
    });
  }
  ...
  async getPetRaw(
    petId: string,
    options?: RequestOptions,
  ): Promise<ApiResponse<GetPetResponseVariant1 | GetPetResponseVariant2>> {
    let path = "/pets/{petId}";
    path = path.replace("{petId}", encodeURIComponent(String(petId)));
    return this.rawRequest<GetPetResponseVariant1 | GetPetResponseVariant2>("GET", path, {
      ...options,
    });
  }
}
